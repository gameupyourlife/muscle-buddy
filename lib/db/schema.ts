...
export const userGamification = pgTable('user_gamification', {
  ...
  characterGender: text('character_gender').notNull().default('male'),
  equippedHeadItem: text('equipped_head_item').notNull().default('headband'),
  equippedTopItem: text('equipped_top_item').notNull().default('standard'),
  equippedPantsItem: text('equipped_pants_item').notNull().default('standard'),
  equippedShoesItem: text('equipped_shoes_item').notNull().default('standard'),
